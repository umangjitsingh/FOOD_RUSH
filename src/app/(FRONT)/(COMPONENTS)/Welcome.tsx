    ...
    return (
        <main className=" overflow-hidden bg-background text-foreground">
            ...
            <section  className="relative mx-auto max-w-360 px-5 py-5 sm:px-8 lg:px-12 scroll-mt-20">
                ...
                {/* Background blobs */}
                <div className="pointer-events-none absolute -right-40 top-8 h-120 w-lg rounded-full bg-primary/10 blur-[130px]" />
                <div className="pointer-events-none absolute bottom-56 left-0 h-120 w-120 rounded-full bg-primary/5 blur-[110px]" />

                {/* Header */}
                <header id="top" className="sticky top-0 z-50 backdrop-blur-md bg-background/80 flex items-center justify-between border-b border-border/70 pt-5 pb-5 px-5 sm:px-8 lg:px-12 ">
                ...
                <div >
                    <div className="absolute -left-28 top-0 w-88 h-90 bg-ring/9 blur-3xl z-100"></div>
                    <div className="relative z-10 grid items-center gap-10 pb-10 md:pb-16
                                lg:min-h-[90vh] lg:grid-cols-[0.95fr_1.05fr] lg:gap-8 md:pt-12 ">

                        {/* Left text */}
                        <div className="max-w-xl">
                            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                                <span className="size-1.5 rounded-full bg-primary" /> Curated for your cravings
                            </div>

                            <h1 className="max-w-2xl font-serif text-5xl font-bold leading-[0.98] tracking-[-0.045em] text-balance sm:text-7xl lg:text-[88px]">
                            ...
                            <div className="mt-8 flex max-w-lg items-center">

                                <button className="flex shrink-0 items-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground transition-transform hover:scale-[1.02] sm:px-5" onClick={()=>whatStep(2)}>
                        ...
                        {/* Right hero image */}
                        <div className="relative mx-auto w-full max-w-158 lg:ml-auto">
                            ...
                            <div className="relative overflow-hidden rounded-[34px] border border-border/80 bg-card p-3 shadow-2xl shadow-black/30 sm:p-4">
                                <div className="relative aspect-[0.94] overflow-hidden rounded-[25px] bg-muted">
                                    ...
                                    <div className="absolute inset-x-5 bottom-5 flex items-end justify-between gap-3 text-white">
                                        <div>
                                            <p className="font-serif text-2xl font-bold">Midnight Ramen</p>
                                            <p className="mt-1 text-sm text-white/70">Kumo Kitchen · 4.9 ★</p>
                                        </div>
                                        <span className="rounded-full bg-white px-3 py-2 text-sm font-bold text-black">$16.50</span>
                                    </div>
                                </div>
                            </div>

                            <div className="absolute -bottom-5 -left-4 flex items-center gap-3 rounded-2xl border border-border bg-card px-4 py-3 shadow-xl sm:-left-10">
                    ...
                    {/* DISCOVER */}
                    <section id="discover" className="relative z-10 border-t border-border/70 py-7 scroll-mt-20">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Pick a mood</p>
                                <h2 className="mt-1 font-serif text-2xl font-bold">What are you feeling?</h2>
                            </div>

                            <div className="flex items-center gap-2 overflow-x-auto pb-1" role="tablist" aria-label="Food categories">
                    ...
                    {/* HOW IT WORKS */}
                    <section id="how-it-works" className="relative z-10 grid gap-3 pb-8 pt-2 sm:grid-cols-3 scroll-mt-20">
                        {[
                            ...
                            <article key={number} className="rounded-2xl border border-border/70 bg-card/55 p-5">
